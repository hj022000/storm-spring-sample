...
package storm.sample.spout.hdfs;
...
public class HdfsFieldsSpout extends BaseRichSpout {
    ...
    private static Values getValues(String suf) {
        ...
        return new Values(
                ...
                "title" + suffix,
                "content" + suffix);         // this field won't be indexed by solr
    }
    ...
    public Fields getOutputFields() {
        return new Fields("id","date","title","content");
    }
