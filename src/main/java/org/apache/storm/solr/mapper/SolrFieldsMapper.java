...
public class SolrFieldsMapper implements SolrMapper {
    ...
    public static class Builder {
         ...
         * {@link SolrFieldsMapper} builder class.
         * @param schemaBuilder Solr {@link Schema} builder class
         * @param solrClient {@link SolrServer} implementation from where to extract the default Solr collection, if any defined.
         */
        public Builder(SchemaBuilder schemaBuilder, SolrServer solrClient) {
            setTypeFinder(schemaBuilder);
        }
        ...
        private void setDefaultCollection(SolrServer solrClient) {
            String defaultCollection = null;
            if (solrClient instanceof CloudSolrServer) {
                defaultCollection = ((CloudSolrServer) solrClient).getDefaultCollection();
            }
